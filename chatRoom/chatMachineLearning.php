...
<html>
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textMachineLearning.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="chatMachineLearning.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="chatMachineLearning.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textMachineLearning.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"chatMachineLearning.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textMachineLearning.txt");
                    echo("<script>");
                    echo("window.location.replace(\"chatMachineLearning.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"chatMachineLearning.php\";");
                    echo("</script>");
               }
            }
          }
