...
<html id="html-toggle">
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textObjectOrientedProgramming.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="chatObjectOrientedProgramming.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="chatObjectOrientedProgramming.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textObjectOrientedProgramming.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"chatObjectOrientedProgramming.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textObjectOrientedProgramming.txt");
                    echo("<script>");
                    echo("window.location.replace(\"chatObjectOrientedProgramming.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"chatObjectOrientedProgramming.php\";");
                    echo("</script>");
               }
            }
          }
