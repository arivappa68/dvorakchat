...
<html id="html-toggle">
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textDatabase.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="chatDatabase.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="chatDatabase.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textDatabase.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"chatDatabase.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textDatabase.txt");
                    echo("<script>");
                    echo("window.location.replace(\"chatDatabase.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"chatDatabase.php\";");
                    echo("</script>");
               }
            }
          }
