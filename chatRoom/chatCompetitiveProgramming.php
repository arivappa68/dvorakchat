...
<html>
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textCompetitiveProgramming.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="chatCompetitiveProgramming.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="chatCompetitiveProgramming.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textCompetitiveProgramming.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"chatCompetitiveProgramming.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textCompetitiveProgramming.txt");
                    echo("<script>");
                    echo("window.location.replace(\"chatCompetitiveProgramming.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"chatCompetitiveProgramming.php\";");
                    echo("</script>");
               }
            }
          }
