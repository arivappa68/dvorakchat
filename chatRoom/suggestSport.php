...
<html id="html-toggle">
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textSport.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="suggestSport.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="suggestSport.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textSport.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"suggestSport.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textSport.txt");
                    echo("<script>");
                    echo("window.location.replace(\"suggestSport.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"suggestSport.php\";");
                    echo("</script>");
               }
            }
          }
