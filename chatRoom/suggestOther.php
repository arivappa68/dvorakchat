...
<html>
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textOther.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="suggestOther.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="suggestOther.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textOther.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"suggestOther.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textOther.txt");
                    echo("<script>");
                    echo("window.location.replace(\"suggestOther.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"suggestOther.php\";");
                    echo("</script>");
               }
            }
          }
