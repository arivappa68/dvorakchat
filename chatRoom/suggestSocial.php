...
<html id="html-toggle">
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textSocial.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="suggestSocial.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="suggestSocial.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textSocial.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"suggestSocial.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textSocial.txt");
                    echo("<script>");
                    echo("window.location.replace(\"suggestSocial.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"suggestSocial.php\";");
                    echo("</script>");
               }
            }
          }
