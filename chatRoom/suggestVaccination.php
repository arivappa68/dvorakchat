...
<html>
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textVaccination.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="suggestVaccination.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="suggestVaccination.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textVaccination.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"suggestVaccination.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    formatmyfile("../text/textVaccination.txt");
                    echo("<script>");
                    echo("window.location.replace(\"suggestVaccination.php\")");
                    echo("</script>");
               }else{
                    ...
                    echo("window.location.href=\"suggestVaccination.php\";");
                    echo("</script>");
               }
            }
          }
