...
<html id="html-toggle">
  ...
  <body>
    <header>
      ...
      <div id="chat">
        <?php readmytext("../text/textUG1.txt"); ?>
      </div>
    </header>
    <main style="text-decoration:none">
      <form class="noselect" autocomplete="off" method="post" action="chatUG1.php">
      ...
      <div id="popup-form" style="display:none">
         <form name="passwordForm" class="form-box" action="chatUG1.php" method="post">
               <div style="display:inline">
      ...
      <?php
        if($_POST){
          if(isset($_POST["writtentext"]) && $_POST["writtentext"]!=null){
             ...
             $name = $_POST["name"];
             appendmytext("../text/textUG1.txt",$writtenText, $name);
             echo("<script>");
             echo("window.location.replace(\"chatUG1.php\")");
             echo("</script>");
          }
          if(isset($_POST["deleteButton"])){
            if($_POST){
               ...
               if($password == "requiredpassword"){
                    ...
                    echo("window.location.href=\"chatUG1.php\";");
                    echo("</script>");
               }
            }
          }
